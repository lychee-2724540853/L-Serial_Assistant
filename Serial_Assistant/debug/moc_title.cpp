...
QT_MOC_LITERAL(1, 6, 23), // "signalWindowSizeChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 23) // "signalWindowSizeRestore"

    },
    "Title\0signalWindowSizeChanged\0\0"
    "signalWindowSizeRestore"
};
...
void Title::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalWindowSizeChanged(); break;
        case 1: _t->signalWindowSizeRestore(); break;
        default: ;
        }
        ...
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::signalWindowSizeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Title::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Title::signalWindowSizeRestore)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Title::signalWindowSizeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Title::signalWindowSizeRestore()
{
